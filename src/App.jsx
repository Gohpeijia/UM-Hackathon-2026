...
export default function App() {
  ...
  const chartData = useMemo(() => MOCK_CHART_DATA[selectedMonth] || [], [selectedMonth]);
                ...
                <div className="chart-wrapper">
                  ...
                  >
                    <div className="anomaly-title">
                      <AlertCircle style={{ width: '12px' }} />
                      Anomaly Detected
                    </div>
                    <p style={{ color: 'var(--text-muted)', margin: 0 }}>UM Mid-Sem Break impact observed in footfall patterns.</p>
                  </motion.div>
                </div>
              </div>
